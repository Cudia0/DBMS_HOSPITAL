...
<div class="tbl-director-form">
    <div class="card">
        <div class="card-header bg-dark text-white">
            <h4 class="mb-0"><i class="fas fa-user-tie"></i> Director Information</h4>
        </div>
        <div class="card-body">
            ...
            <div class="form-group mt-4">
                <?= Html::submitButton('<i class="fas fa-save"></i> Save Director', [
...
$this->registerJs("
    ...
    // FORM SUBMISSION
    // ==========================================
    $('#director-form').on('beforeSubmit', function() {
        var email = $('#director-email').val().trim();
        if (email && email !== 'N/A' && email !== 'n/a') {
            var gmailRegex = /^[a-zA-Z0-9._%+-]+@gmail\.com$/;
            if (!gmailRegex.test(email)) {
    ...
    $(document).ready(function() {
        ...
        if (initialCountryCode) {
            $('#director-country_code').trigger('change');
        }
