...
// DIRECTOR MENU
if ($role === 'director') {
    $menuItems[] = ['label' => '<i class="fas fa-cog"></i> Master Data', 'items' => [
    ...
    $menuItems[] = ['label' => '<i class="fas fa-users"></i> Staff', 'items' => [
    ...
    $menuItems[] = ['label' => '<i class="fas fa-clipboard-list"></i> Clinical', 'items' => [
    ...
    $menuItems[] = ['label' => '<i class="fas fa-file-invoice"></i> Billing', 'items' => [
    ...
    $menuItems[] = ['label' => '<i class="fas fa-shield-alt"></i> System', 'items' => [
...
elseif ($role === 'receptionist') {
    ...
    $menuItems[] = ['label' => '<i class="fas fa-clipboard-list"></i> Clinical (View)', 'items' => [
        ['label' => '<i class="fas fa-notes-medical"></i> Medical Records', 'url' => ['/medical-record/index']],
        ['label' => '<i class="fas fa-prescription"></i> Prescriptions', 'url' => ['/prescription/index']],
        ['label' => '<i class="fas fa-flask"></i> Lab Tests', 'url' => ['/lab-test/index']],
    ]];
...
// GUEST & ALL USERS - About and Contact always visible
...
<header id="header">
    <?php NavBar::begin([
        'brandLabel' => Html::img('@web/images/medisync-logo-light.svg', ['alt' => 'MediSync', 'height' => 40, 'class' => 'd-inline-block align-top me-2']) . ' MediSync',
